...
export default function NewPostPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-[760px] space-y-8 px-6 py-10 md:px-10">
      <Link href="/forum" className="text-sm text-text-muted hover:text-text-strong">← Community</Link>
      ...
      <Card className="space-y-5 p-6" hover={false}>
        ...
        <div className="flex items-center justify-end gap-2">
          <Link href="/forum" className="rounded-full border border-stroke-weak px-4 py-2 text-sm">
            Cancel
          </Link>
