...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Most chat communities optimize for activity; we optimize for outcomes. Conversations are anchored to your work, your topics, and your goals — not the loudest channel of the day. Your work lives here, not in a feed.",
  },
  {
    q: "Do I have to pay to join?",
    a: "Reading critiques, browsing tools, and following topics is free. Premium topics and deeper learning paths are part of the Member plan — month-to-month, no contracts.",
  },
  {
    q: "How do critiques work?",
    a: "Drop your work into a public crit thread. Crits get focused community comments within 24h — a written summary of what's working and what to push on next.",
  },
  {
